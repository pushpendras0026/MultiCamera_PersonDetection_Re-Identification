...
import os
# from keras.utils import multi_gpu_model  # Removed in TF 2.x
...
class YOLO4(object):
    ...
    def __init__(self, sess=None, **kwargs):
        ...
        self.sess = tf.compat.v1.keras.backend.get_session() if sess is None else sess
    ...
    def generate(self):
        ...
        with self.sess.as_default():
            try:
                ...
                assert self.yolo_model.output[0].shape[-1] == \
